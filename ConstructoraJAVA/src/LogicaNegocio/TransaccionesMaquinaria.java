...
public class TransaccionesMaquinaria {
    ...
    public void modificar(String nombre, String tipoMaquinaria, String marca, String precioDia, String existencia, int idMaquinaria){
        try {
            maq=new Maquinaria(nombre, tipoMaquinaria, marca, Double.parseDouble(precioDia),Integer.valueOf(existencia),idMaquinaria);
